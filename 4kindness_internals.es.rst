Cursito intermedio de asm para la c64: Haciendo una intro 4k
============================================================
...
Hola. Primero bajarse el 4Kindness para darse una idea de lo que abarca
el cursito:

-  `4kindness.d64 <https://github.com/c64scene-ar/4kindness/raw/master/bin/4kindness.d64>`__

Listo, empecemos. Hay dos cosas que vamos a ver en este cursito:
...
En el cursito anterior vimos como hacer un scroll con sprites. Es un buen momento para
releerlo en caso que se lo hayan olvidado:
...
Hacer un scroll con sprites hi-res, o con en modo gráfico hir-es es básimante lo mismo.
Repasemos el modo gráfico hi-res:
